  ...
  _createClass(Main, [{
    ...
    value: function componentWillMount() {
      ...
      _axios2.default.get('/api/players').then(function (res) {
        ...
        return _this2.setState({ players: players });
      });
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_reactRouterDom.Route, { path: '/teams', exact: true, render: function render() {
              return _react2.default.createElement(_Teams2.default, { teams: teams });
            } })
        )
      );
    }
    ...
    _react2.default.createElement(
      ...
      teams && teams.map(function (team) {
        return _react2.default.createElement(
          ...
          team.name,
          ': ',
          team.players.length === 1 ? team.players.length + ' player' : team.players.length + ' players'
        );
      })
    )
  );
...
var Nav = function Nav(_ref) {
  ...
  return _react2.default.createElement(
    'ul',
    { style: { marginTop: 15, marginBottom: 15 }, className: 'nav nav-pills' },
    _react2.default.createElement(
      'li',
      { className: 'nav-item' },
      path === '/' ? _react2.default.createElement(
        ...
        { className: 'nav-link font-weight-bold', to: '/' },
        'Home'
      )
    ),
    _react2.default.createElement(
      ...
      path === '/players' ? _react2.default.createElement(
        ...
        _reactRouterDom.Link,
        { className: 'nav-link font-weight-bold', to: '/players' },
        'Players'
      )
    ),
    _react2.default.createElement(
...
var Home = function Home() {
  return _react2.default.createElement(
    'h1',
    null,
    'These are players and teams built in React'
  );
};
